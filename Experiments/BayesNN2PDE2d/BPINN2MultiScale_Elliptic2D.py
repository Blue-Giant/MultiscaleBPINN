...
def solve_bayes(Rdic=None):
    ...
    N_tr_u = 100     # the number of sampled points for dealing with solution, i.e., boundary
    N_tr_f = 900    # the number of sampled points for dealing with force-side, i.e., governed equation for interior
    ...
    if 'mesh_grid' == str.lower(Rdic['opt2sampling']):
        ...
        clean_f = f(data["x_f"])                                 # the exact solution without noise on interior points
...
if __name__ == "__main__":
    ...
    R['PDE_type'] = 'Multiscale_Elliptic'
