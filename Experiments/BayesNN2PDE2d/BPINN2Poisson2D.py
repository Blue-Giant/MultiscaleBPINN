...
def solve_bayes(Rdic=None):
    ...
    plot2Bayes.plot_scatter_solution2test(solu2test, test_xy=x_val, name2solu='BPINN', outPath=R['FolderName'])
    plot2Bayes.plot_scatter_solution2test(u_val, test_xy=x_val, name2solu='Exact', outPath=R['FolderName'])
    plot2Bayes.plot_scatter_solution2test(point_abs_errs, test_xy=x_val, name2solu='Absolute Error',
...
if __name__ == "__main__":
    ...
    if R['mode2update_para'] == 'PINN':
        ...
        R['learning_rate'] = 0.000015  # this is the learning rate for optimizer in Hamilton  model 2FF
        R['step2update_lr'] = 25
