...
def solve_bayes(Rdic=None):
    ...
    rel2k_list = []
    rel2f_list = []
    list2ham_itea = [200, 300, 400, 500, 600, 700, 800, 900, 1000, 1500]
    for num2ham_sample in list2ham_itea:
        ...
        if 'PINN' == Rdic['mode2update_para']:
            ...
            params_hmc = BayesNN_Utils.update_paras_by_hamilton(
                nets, data, model_loss=model_loss, num_samples=num2ham_sample, num_steps_per_sample=L,
        ...
        Log_Print2Bayes.print_log_mse_rel(mse2solu=mse2U, rel2solu=rel2U, mse2para=mse2K, rel2para=rel2K,
                                          mse2force=mse2F,
...
if __name__ == "__main__":
    ...
    store_file = 'Bayes1D_Hamilton_itea'
