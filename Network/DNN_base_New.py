...
class Scale_SubNets3D(tn.Module):
    ...
    def __call__(self, inputs, scale=None, sFourier=1.0):
        ...
        shape2scale = scale.shape
        assert (len(shape2scale) == 3)
...
class Fourier_FeatureDNN(tn.Module):
    ...
    def __init__(self, indim=1, outdim=1, hidden_units=None, name2Model='DNN', actName2in='tanh', actName='tanh',
                 actName2out='linear', scope2W='Weight', scope2B='Bias', repeat_Highfreq=True, type2float='float32',
                 to_gpu=False, gpu_no=0, with_grad2FF=False, sigma=10.0):
        ...
        # wff2tensor = torch.empty((indim, hidden_units[0]//2), dtype=self.float_type)
        # Win = tn.Parameter(wff2tensor, requires_grad=False)
        # tn.init.normal_(Win, mean=0.0, std=1.0)*sigma
        # self.W_FF = Win
        ...
        self.FF_layer.weight.requires_grad = with_grad2FF
...
class Multi_2FF_DNN(tn.Module):
    ...
    def __init__(self, indim=1, outdim=1, hidden_units=None, name2Model='DNN', actName2in='tanh', actName='tanh',
                 actName2out='linear', scope2W='Weight', scope2B='Bias', repeat_Highfreq=True, type2float='float32',
                 to_gpu=False, gpu_no=0, with_grad2FF=False, sigma1=1.0, sigma2=10.0):
        ...
        self.FF_layer1.weight.requires_grad = with_grad2FF
        ...
        self.FF_layer2.weight.requires_grad = with_grad2FF
...
class Multi_3FF_DNN(tn.Module):
    ...
    def __init__(self, indim=1, outdim=1, hidden_units=None, name2Model='DNN', actName2in='tanh', actName='tanh',
                 actName2out='linear', scope2W='Weight', scope2B='Bias', repeat_Highfreq=True, type2float='float32',
                 to_gpu=False, gpu_no=0, with_grad2FF=False, sigma1=1.0, sigma2=10.0, sigma3=20.0):
        ...
        self.FF_layer3.weight.requires_grad = with_grad2FF
...
class Multi_4FF_DNN(tn.Module):
    ...
    def __init__(self, indim=1, outdim=1, hidden_units=None, name2Model='DNN', actName2in='tanh', actName='tanh',
                 actName2out='linear', scope2W='Weight', scope2B='Bias', repeat_Highfreq=True, type2float='float32',
                 to_gpu=False, gpu_no=0, with_grad2FF=False, sigma1=1.0, sigma2=10.0, sigma3=20.0, sigma4=50.0):
        ...
        self.FF_layer4.weight.requires_grad = with_grad2FF
...
class Multi_5FF_DNN(tn.Module):
    ...
    def __init__(self, indim=1, outdim=1, hidden_units=None, name2Model='DNN', actName2in='tanh', actName='tanh',
                 actName2out='linear', scope2W='Weight', scope2B='Bias', repeat_Highfreq=True, type2float='float32',
                 to_gpu=False, gpu_no=0, with_grad2FF=False, sigma1=1.0, sigma2=10.0, sigma3=20.0, sigma4=40.0,
                 sigma5=80.0):
        ...
        tn.init.normal_(self.FF_layer4.weight, mean=0.0, std=1.0) * sigma5
        self.FF_layer5.weight.requires_grad = with_grad2FF
...
class Multi_8FF_DNN(tn.Module):
    ...
    def __init__(self, indim=1, outdim=1, hidden_units=None, name2Model='DNN', actName2in='tanh', actName='tanh',
                 actName2out='linear', scope2W='Weight', scope2B='Bias', repeat_Highfreq=True, type2float='float32',
                 to_gpu=False, gpu_no=0, with_grad2FF=False, sigma1=1.0, sigma2=10.0, sigma3=20.0, sigma4=40.0,
                 sigma5=60.0, sigma6=80.0, sigma7=100.0, sigma8=120.0):
        ...
        self.FF_layer6.weight.requires_grad = with_grad2FF
        ...
        self.FF_layer7.weight.requires_grad = with_grad2FF
        ...
        self.FF_layer8.weight.requires_grad = with_grad2FF
...
class Dense_FourierNet(tn.Module):
    ...
    def forward(self, inputs, scale=None, sFourier=1.0, training=None, mask=None):
        ...
        H = sFourier*torch.cat([torch.cos(H*scale), torch.sin(H*scale)], dim=-1)
...
class Fourier_SubNets3D(tn.Module):
    ...
    def __call__(self, inputs, scale=None, sFourier=1.0):
        ...
        out_result = self.actFunc_out(H)
        # out_result = tf.multiply(out_result, self.weight2subnets)
        out_result = torch.multiply(out_result, 1.0/scale)
        out_result = torch.mean(out_result, dim=0)
        return out_result
